...
from evennia import DefaultCharacter, DefaultAccount, CmdSet, DefaultObject
...
class CmdSelf:
    ...
    permissions: str
    help_category: str
    caller: Union[DefaultAccount, DefaultCharacter]
    cmdstring: str
    args: str
    cmdset: CmdSet
    obj: DefaultObject
...
class Command(BaseCommand):
    ...
    def at_post_cmd(self: CmdSelf):
        return super().at_post_cmd()

    def parse(self: CmdSelf):
        return super().parse()
    
    def func(self: CmdSelf):
        return super().func()
